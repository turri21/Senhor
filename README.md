...
Updates: DigDug, Defender, CrazyKong, CrazyClimber, Cosmic, MSX, PSX, ComputerSpace, CongoBongo, Chameleon
...
Finally, you are going to need a Micro SD card of minimum 2 GB and a custom Linux distribution flashed to it, such as [Mr. Fusion for Senhor](https://codeberg.org/turri21/Senhor/src/branch/main/MrFusion) in order to be able to boot the system, browse the menu and load the cores.

...
You can find all the forked [sources on my repos](https://github.com/turri21?tab=repositories) having the CoreName_Senhor naming scheme. For example: Minimig_Senhor, N64_Senhor, Saturn_Senhor etc

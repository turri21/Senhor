...
IremM90: Bomber Man World - New Dyna Blaster - Global Quest - If ROM PO CHECK ERROR is displayed load the Bomber Man - Dyna Blaster first and while running load the Global Quest.
Alternatively, you can try to reset the core several times until it loads.
